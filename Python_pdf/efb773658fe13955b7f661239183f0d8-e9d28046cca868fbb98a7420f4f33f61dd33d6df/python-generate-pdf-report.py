...
def generate_pdf():
    ...
    if not student_id:
        return "<h2>Error: Please enter a Student ID.</h2>"

    pdf = PDF()
    pdf.add_page()
    
    # **Header: Logo**
    pdf.image(r'C:\Users\admin\Downloads\New folder\Assignment3CS415\Python_pdf\efb773658fe13955b7f661239183f0d8-e9d28046cca868fbb98a7420f4f33f61dd33d6df\USP_logo.jpg', x=(pdf.w - 50) / 2, y=5, w=50)
    pdf.ln(35)
    ...
    student_info = fetch_data("SELECT StudentID, Name, DateOfBirth FROM StudentDetails WHERE StudentID = ?", (student_id,))
    ...
    # **Save the PDF**
    pdf_filename = f"C:\\Users\\admin\\Downloads\\New folder\\Assignment3CS415\\Python_pdf\\efb773658fe13955b7f661239183f0d8-e9d28046cca868fbb98a7420f4f33f61dd33d6df\\static\\Student_{student_id}_Transcript.pdf"
